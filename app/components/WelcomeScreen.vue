    ...
    >
      ...
      <div class="relative min-h-screen flex items-center justify-center px-4">
        <div class="w-full max-w-4xl mx-auto">
          <motion.div
            class="flex justify-center gap-3 sm:gap-4 md:gap-8 mb-6 sm:mb-8 md:mb-12"
            :exit="{ y: -20, opacity: 0 }"
            :transition="{
              duration: 0.4,
              ease: 'easeInOut',
          ...
          >
            ...
            >
              ...
              >
                <i
                  :class="[
                    'sm:text-base md:text-lg lg:text-2xl text-white',
                    item.icon,
                  ]"
                />
              </div>
          ...
          <motion.div
            class="text-center mb-6 sm:mb-8 md:mb-12"
            :exit="{ y: -20, opacity: 0 }"
            :transition="{
              duration: 0.4,
              ease: 'easeInOut',
          ...
          >
            <h1
              class="text-3xl sm:text-4xl md:text-6xl font-bold space-y-2 sm:space-y-4"
            >
          ...
          >
            <a
              href="https://www.dilzz.vercel.app"
            ...
            >
              ...
              >
                ...
                >
                  <TypewriterEffect text="www.dilzz.vercel.app" />
                </span>
              </div>
            </a>
          </motion.div>
